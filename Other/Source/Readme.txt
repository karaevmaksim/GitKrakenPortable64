...
user in an INI file next to GitKrakenPortable64.exe called GitKrakenPortable64.ini.
...
copy AppNamePortable.ini from this directory to GitKrakenPortable64.ini next to
GitKrakenPortable64.exe. The options in the INI file are as follows:
